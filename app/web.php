...
Route::get('perjalananDalam/{id}/edit', [SuratController::class, 'edit']);
Route::put('perjalananDalam/{id}', [SuratController::class, 'update']);
...
Route::get('/kendaraan_create', [KendaraanController::class, 'create']);
