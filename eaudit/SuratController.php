...
class SuratController extends Controller
{
    public function indexDalam(Request $request)
    {
            ...
            if ($request->has('search')) {
                ...
                $penugasan = Penugasan::where('created_at','like','%'.session('tahun').'%')->where('noSurat	','like','%'.$request->search.'%')->orderBy('TanggalAkhir','DESC')->paginate(5);
            }else {
                # code...
                $surat = suratTugas::all();
    ...
    public function store(Request $request)
    {
        ...
        foreach ($request->input('tugas') as $id_peran => $value) {
            ...
            $s = DB::select("SELECT COUNT(id) AS total FROM  surat_tugas WHERE  ((ta <= '$ta' AND tp >= '$ta') OR  (ta >= '$ta' AND tp <= '$ta') OR (ta >= '$ta' AND ta <= '$tp')) AND id_karyawan = '$id_karyawan' " );
        if ($s[0]->total > 0) {
            $z = DB::select("SELECT pegawais.nama_karyawan AS data1, jenis_pengawasans.nama AS data2, obriks.nama AS data3, surat_tugas.ta AS data4, surat_tugas.tp AS data5 FROM  surat_tugas JOIN pegawais ON pegawais.id = surat_tugas.id_karyawan JOIN penugasans ON penugasans.id = surat_tugas.id_penugasan JOIN jenis_pengawasans ON jenis_pengawasans.id = penugasans.id_jenis_pengawasan JOIN obriks ON obriks.id = penugasans.id_obrik WHERE  ((ta <= '$ta' AND tp >= '$ta') OR  (ta >= '$ta' AND tp <= '$ta') OR (ta >= '$ta' AND ta <= '$tp')) AND surat_tugas.id_karyawan = '$id_karyawan'" );
                $jumlahdobeljob += 1;
        ...
        foreach ($x['tugas'] as $id_peran => $value ) {
            ...
            $sc = DB::select("SELECT COUNT(id) AS total FROM  surat_tugas WHERE  ta >= '$ta' AND ta <= '$tp' AND id_karyawan = '$id_karyawan'  " );
            $sd = DB::select("SELECT COUNT(id) AS total FROM  surat_tugas WHERE  ta <= '$ta' AND tp >= '$ta' AND id_karyawan = '$id_karyawan'  " );
            ...
            $s2 = DB::select("SELECT COUNT(id) AS total FROM  surat_tugas WHERE  ta >= '$ta' AND tp <= '$ta' AND id_karyawan = '$id_karyawan'  " );
            // $s3 = DB::select("SELECT COUNT(id) AS total FROM  surat_tugas WHERE  ta <= '$ta' AND tp <= '$tp' AND id_karyawan = '$id_karyawan'  " );
            if ($sc[0]->total > 0) {
                # code...
                $z2 = DB::select("SELECT ta, tp,id FROM  surat_tugas WHERE  ta >= '$ta' AND ta <= '$tp' AND id_karyawan = '$id_karyawan' " );
               ...
               $xy['ta'] = $taAkhir;
                ...
                elseif ($sd[0]->total > 0) {
                $z = DB::select("SELECT ta, tp, id FROM  surat_tugas WHERE ta <= '$ta' AND tp >= '$tp' AND id_karyawan = '$id_karyawan' " );
            ...
            //     $tpAkhir = date('Y-m-d',strtotime($tp.' +1 day'));
            //     $xy['ta'] = $tpAkhir;
            //     suratTugas::where("id",$z[0]->id)->update($xy);
            ...
            // elseif ($s3[0]->total > 0) {
            //     # code...
            //     $z2 = DB::select("SELECT ta, tp,id FROM  surat_tugas WHERE  ta <= '$ta' AND tp <= '$tp' AND id_karyawan = '$id_karyawan' " );
            //     $taAkhir = date('Y-m-d',strtotime($ta.' -1 day'));
    ...
    public function edit($id)
    {
        ...
        $surat2 = suratTugas::where('id_penugasan',$id)->where('id_peran','7')->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        //  $jumlahdobeljob2 = $jumlahdobeljob;
         ...
         foreach ($request->input('anggota') as $id_peran => $value ) {
            ...
            if ($jumlahdobeljob2 > 0) {
                # code...
                return redirect('perjalananDalam/'.$id.'/edit')->with('danger', $dobeljob2);
        ...
        foreach ($x['ubahtugas'] as $id_suratTugas => $value ) {
            if (!empty($value['id_karyawan'])) {
                ...
                $sd = DB::select("SELECT COUNT(id) AS total FROM  surat_tugas WHERE  ta <= '$ta' AND tp >= '$ta' AND id_karyawan = '$id_karyawan'  " );
                // $s = DB::select("SELECT COUNT(id) AS total FROM  surat_tugas WHERE ((ta <= '$ta' AND tp >= '$ta') OR (ta <= '$tp' AND tp >= '$tp')) AND id_karyawan = '$id_karyawan'" );
                $s2 = DB::select("SELECT COUNT(id) AS total FROM  surat_tugas WHERE  ta >= '$ta' AND tp >= '$tp' AND id_karyawan = '$id_karyawan'  " );
                $s3 = DB::select("SELECT COUNT(id) AS total FROM  surat_tugas WHERE  ta <= '$ta' AND tp <= '$tp' AND id_karyawan = '$id_karyawan'  " );
                if ($sc[0]->total > 0) {
                    # code...
                    $z2 = DB::select("SELECT ta, tp,id FROM  surat_tugas WHERE  ta >= '$ta' AND ta <= '$tp' AND id_karyawan = '$id_karyawan' " );
        ...
        //     }
                ...
                $surat = suratTugas::find($id_suratTugas);
                $surat->id_karyawan = $value['id_karyawan'];
                $surat->ta = $value['ta'];
                $surat->tp = $value['tp'];
                $surat->update();
        ...
        foreach ($x['anggota'] as $id_peran => $value ) {
            ...
            foreach ($x['ubahanggota'] as $id_suratTugas => $value) {
                # code...
                $ta = $value['ta'];
                $tp = $value['tp'];
                $id_karyawan = $value['id_karyawan'];
    ...
    public function arsipCari(Request $request)
    {
        ...
        if($request->obrik AND $request->jenisPengawasan AND $request->bulan) {
            ...
            $penugasan = Penugasan::join('obriks', 'obriks.id', '=', 'penugasans.id_obrik')->join('jenis_pengawasans', 'jenis_pengawasans.id', '=', 'penugasans.id_jenis_pengawasan')->where('obriks.nama','like','%'.$request->obrik.'%')->where('jenis_pengawasans.nama','like','%'.$request->jenisPengawasan.'%')->whereMonth('penugasans.TanggalSurat','=',$request->bulan)->whereYear('TanggalSurat',session('tahun'))->get();
        }elseif ($request->obrik AND $request->jenisPengawasan AND $request->bulan) {
            $surat = suratTugas::all();
            $obrik = $request->Obrik;
            $jenisPengawasan = $request->jenisPengawasan;
            $filterbulan = $request->bulan;
        ...
        elseif ($request->obrik AND $request->jenisPengawasan) {
            ...
            $obrik = $request->Obrik;
            $jenisPengawasan = $request->jenisPengawasan;
            $penugasan = Penugasan::join('obriks', 'obriks.id', '=', 'penugasans.id_obrik')->join('jenis_pengawasans', 'jenis_pengawasans.id', '=', 'penugasans.id_jenis_pengawasan')->where('obriks.nama','like','%'.$request->obrik.'%')->where('jenis_pengawasans.nama','like','%'.$request->jenisPengawasan.'%')->whereYear('TanggalSurat',session('tahun'))->get();
        }
        elseif ($request->obrik AND $request->bulan) {
            $surat = suratTugas::all();
            $obrik = $request->Obrik;
            $filterbulan = $request->bulan;
            $penugasan = Penugasan::join('obriks', 'obriks.id', '=', 'penugasans.id_obrik')->where('obriks.nama','like','%'.$request->obrik.'%')->whereMonth('penugasans.TanggalSurat','=',$request->bulan)->whereYear('TanggalSurat',session('tahun'))->get();
        }elseif ($request->obrik) {
            $surat = suratTugas::all();
            $obrik = $request->Obrik;
            $penugasan = Penugasan::join('obriks', 'obriks.id', '=', 'penugasans.id_obrik')->where('obriks.nama','like','%'.$request->obrik.'%')->whereYear('TanggalSurat',session('tahun'))->get();
        }
        ...
        elseif ($request->jenisPengawasan) {
            $surat = suratTugas::all();
            $jenisPengawasan = $request->jenisPengawasan;
            // $penugasan = Penugasan::join('jenis_pengawasans', 'jenis_pengawasans.id', '=', 'penugasans.id_jenis_pengawasan')->where('jenis_pengawasans.nama','like','%'.$request->jenisPengawasan.'%')->whereYear('TanggalSurat',session('tahun'))->get();
            $penugasan = Penugasan::whereHas('jenis', function($query) use($term) {
                $query->where('nama', 'like', '%'.$request->jenisPengawasan.'%');
            })->get();
         }else {
            # code...
            $surat = suratTugas::all();
    ...
    public function suratEdit($id)
    {
        ...
        foreach ($x['tugas'] as $id_peran => $value ) {
            if (!empty($value['id_karyawan'])) {
                ...
                $sc = DB::select("SELECT COUNT(id) AS total FROM  surat_tugas WHERE  ta >= '$ta' AND tp >= '$ta' AND id_karyawan = '$id_karyawan'  " );
                $sd = DB::select("SELECT COUNT(id) AS total FROM  surat_tugas WHERE  ta <= '$ta' AND tp >= '$ta' AND id_karyawan = '$id_karyawan'  " );
                // $s = DB::select("SELECT COUNT(id) AS total FROM  surat_tugas WHERE ((ta <= '$ta' AND tp >= '$ta') OR (ta <= '$tp' AND tp >= '$tp')) AND id_karyawan = '$id_karyawan'" );
                $s2 = DB::select("SELECT COUNT(id) AS total FROM  surat_tugas WHERE  ta <= '$tp' AND tp >= '$tp' AND id_karyawan = '$id_karyawan'  " );
                if ($sc[0]->total > 0) {
                    # code...
                    $z2 = DB::select("SELECT ta, tp,id FROM  surat_tugas WHERE  ta >= '$ta' AND tp >= '$ta' AND id_karyawan = '$id_karyawan' " );
                    $taAkhir = date('Y-m-d',strtotime($tp.' +1 day'));
