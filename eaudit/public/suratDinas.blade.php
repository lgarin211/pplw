  ...
  /* ... the rest of the rules ... */
    .page {
        ...
        <div class="page">
            <div id="colres" >
                <div class="disp" >
                    <img class="logo" src="{{ asset('logo/1683687704.png') }}"/><h6 class="up">Pemerintah Kabupaten Sragen</h6><h5 class="up" id="nama">Inspektorat  Daerah</h5><br/><h6 class="status">Jl.Dr.Setia Budhi No.20 Telp/Fax (0271) 891147</h6><span id="alamat">Website www.sragenkab.go.id E-mail: <u>Inspektorat@sragenkab.go.id.</u> Kode Pos 57212</span>
                </div>
                <div class="separator2"></div><div class="separator1"></div><div id='surat'><br><table border='0' >
                    ...
                    <tr><td >Nomor &emsp;</td><td> : </td><td>{{ '094/' . $st->noSurat . '/03' . '/' . date('Y') }}</td></tr>
                    </table></div>
                    ...
                    <tr style="border-bottom: none;border-top: none;"><td class="tgh" rowspan="3">3</td>
                        ...
                        <td style="border-bottom: none;border-top: none;">a. {{ $item->pegawai->pangkat->PangkatBaru }} - {{ $item->pegawai->pangkat->Golongan }}</td></tr>
