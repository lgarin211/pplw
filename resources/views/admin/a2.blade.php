                                ...
                                <table>
                                  ...
                                  <tr height="20px" id="tb"><td colspan="12" id="tb"></td></tr>
                                   ...
                                   <td colspan="12" style="border-bottom: none;border-top: none;"></td>
                                                  ...
                                                  <tr>
                                                      <td class="tgh" colspan="4" width="350"> <p style="margin-left: -120px">Pengguna Anggaran</p>
                                                        <br><br><br><br><u><strong>{{$skpd->Pemimpin->NamaBaru}}  </strong></u><br> <p style="margin-left: -100px; margin-top:3px">
                                                            {{$skpd->Pemimpin->Pangkat->PangkatBaru}}
                                                        </p>
                                                        <p style="margin-left: -65px; margin-top: -10px">
                                                            NIP. {{ $skpd->Pemimpin->nip }}
                                                        </p>
                                                        </td>

                                                        <td  class="tgh" colspan="4" width="290">Pejabat Pelaksana Teknis Kegiatan (PPTK)
                                                            <br><br><br><br><u><strong> <p style="margin-top: 12px; margin-left:3px">
                                                            ...
                                                            <p style="margin-left: -25px; margin-top:-10px">
                                                                NIP.  <?php echo isset($penugasan->anggaran->pptk->NamaBaru)?$penugasan->anggaran->pptk->nip:'Belum di tentukan ' ?>
                                                            </p>
                                                        </td>

                                                        <td  class="tgh" colspan="4" width="250">
