...
<style>
 ...
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css" integrity="sha512-vKMx8UnXk60zUwyUnUPM3HbQo8QfmNx7+ltw8Pm5zLusl1XIfwcxo8DbWCqMGKaWeNxWA8yrx5v3SaVpMvR3CA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    ...
    <h5>Daftar Surat Tugas dan SPPD </h5>
        ...
        <div class="d-flex justify-content-end "><a href="{{ url('perjalananDalam_create') }}" class="btn btn-success mb-3">Tambah Penugasan</a>
        </div>
                        ...
                        <td><?php echo isset($v->obrik->nama)?$v->obrik->nama:' ' ?></td>
                            ...
                            <div class="toolbox">
                                ...
                                <form action="{{ url('perjalananDalam/'.$v->id.'/hapus') }}" method="POST" class="d-inline mb-3">
                                    @method('delete')
                                    @csrf
                                    <button class="btn btn-info btn-sm"><i class='fa fa-close'></i></button>
                                    {{-- <a href='' id='1437' class='remove'></a> --}}
                                </form>
                            </div>
                        </td>
                        <td scope="row">
