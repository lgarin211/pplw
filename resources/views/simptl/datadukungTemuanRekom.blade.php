...
<table id="mytable" class="mt-2" style="width: 100%">
    ...
    <tbody class="table-border-bottom-0" id="tbody" style="background-color: white">
        ...
        <tr>
                                ...
                                <td>{{ $v->tipe }}</td>
                                <td>
                                    <a href="{{ url('simptl/datadukung_editTemuan/' . $v->id . '/edit') }}"class="btn btn-outline-success btn-sm" id="Btn" onclick="myFunction()">Edit </a>
                                    {{-- <a href="{{ url('simptl/tipeB_detail/' . $v->id) }}"class="btn btn-outline-primary btn-sm mt-2">Detail </a> --}}
                                </td>
        </tr>
        @endforeach
    </tbody>
