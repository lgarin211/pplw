        ...
        <div class="col-sm-12">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-start ">
                    <a href="{{ url('jabatan_baru') }}" class="btn btn-primary mr-2">Tambah Kelompok Temuan</a>
                    <a href="{{ url('jabatan_baru') }}" class="btn btn-success mr-2">Tambah Sub Kelompok Temuan</a>
                    <a href="{{ url('jabatan_baru') }}" class="btn btn-warning text-light mr-2">Tambah Jenis Temuan</a>         </div>
